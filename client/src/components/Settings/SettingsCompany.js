                    ...
                    <Col xs={{span: 6, offset: 1}} sm={{span: 7, offset: 1}} md={{span: 8, offset: 1}}
                        ...
                        <Row>
                            <Col sm={9} md={8} lg={6} className="colonne-centree">
                                ...
                                {this.state.isModifying === false
                                    ? <Card className="card"><Card.Body><b>Email :</b> {this.state.email}
                                    </Card.Body></Card>
                                    : <Form>
                                ...
                                {this.state.isModifying === false
                                    ? <Card className="card"><Card.Body><b>Numéro de Siret :</b> {this.state.numSiret}
                                    </Card.Body></Card>
                                    : <Form>
                                ...
                                {this.state.isModifying === false
                                    ? <Card className="card"><Card.Body><b>Numéro de Téléphone :</b> {this.state.numTel}
                                    </Card.Body></Card>
                                    : <Form>
                                ...
                                {this.state.isModifying === false
                                    ? <Card className="card"><Card.Body><b>Code Postal :</b> {this.state.codePostal}
                                    </Card.Body></Card>
                                    : <Form>
                                ...
                                {this.state.isModifying === false
                                    ? <Card className="card"><Card.Body><b>Ville :</b> {this.state.ville}
                                    </Card.Body></Card>
                                    : <Form>
                        ...
                        <Row>
                            <Col sm={6} md={5} lg={4} className="colonne-centree" style={{marginTop: 15}}>
                                {this.state.isModifying === false ?
                                    <Button onClick={this.modify.bind(this)} variant='light' block>MODIFIER VOS
                                        INFORMATIONS</Button>
